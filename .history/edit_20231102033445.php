...
<form action="update_product.php" method="post">
    ...
    description 3: <input type="text" name="name3" value="<?php echo $name3; ?>"><br><br>
    education 3: <input type="text" name="name3" value="<?php echo $name3; ?>"><br><br>
    achievements 3: <input type="text" name="name3" value="<?php echo $name3; ?>"><br><br>
