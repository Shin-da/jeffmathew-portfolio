...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE profile SET name1 = '$name1', name2 = '$name2', name3 = '$name3', description = '$contact', email = '$email', gender = '$gender', course = '$course', image = '$image' WHERE studid = '$studid'";
