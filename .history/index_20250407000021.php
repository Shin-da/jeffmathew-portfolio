 ...
 ?>
  ...
  <div class="container px-4 px-lg-5">
    <a class="navbar-brand" href="#page-top">
      <font color="#8d7142"><?php echo $row["name1"]; ?></font>
      <font color="#544c33"><?php echo $row["name2"]; ?></font>
      </a>
  ...
  <div class="container-fluid  about" style="height:190vh;">
    <div class="container" id="about">

      <DIV class=" container-fluid cards">
        <div class="container d-flex flex-row justify-content-center" style="gap:2vw; margin-bottom:2vh;">
          <div class="photo">
            <img src="nstp.png" alt="photo of me">
          </div>
        ...
        <div class="container d-flex flex-row justify-content-around align-items-center">
          <div class="photo">
            <img src="plmun.jpg" alt="photo of plmun">
          </div>

          <div class="card-container educCard">
            <div class="card">
              <div class="front-content">
                <p>Education</p>
              </div>
  ...
  <div class="container-fluid  projects" style="height:90vh;">
    <div class="container" id="projects">
      <h2 class="text-center mb-5" style="color: #544c33;">My Projects</h2>
      <div class="row g-4">
        <!-- Project 1 -->
        <div class="col-md-6 col-lg-4">
          <div class="project-card">
            ...
            <div class="project-content">
              ...
              <p>A web application for managing and organizing your reading list.</p>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="project-card">
            ...
            <div class="project-content">
              ...
              <p>A utility tool for converting time between different formats.</p>
              <div class="project-tech">
                <span>HTML</span>
                <span>CSS</span>
                <span>JavaScript</span>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="project-card">
            ...
            <div class="project-content">
              ...
              <p>A dynamic calendar application with event management features.</p>
              <div class="project-tech">
                <span>HTML</span>
                <span>CSS</span>
                <span>JavaScript</span>
  ...
  <div class="container-fluid   contact" style="height:90vh;">
    <div class="container d-flex justify-content-center" id="contact">
      <div class="socials">
        <a class="socialContainer containerOne" href="https://instagram.com/yourusername" target="_blank">
        ...
        <a class="socialContainer containerTwo" href="https://twitter.com/yourusername" target="_blank">
        ...
        <a class="socialContainer containerThree" href="https://linkedin.com/in/yourusername" target="_blank">
          <svg viewBox="0 0 448 512" class="socialSvg linkdinSvg">
            <path d="M100.28 448H7.4V148.9h92.88zM53.79 108.1C24.09 108.1 0 83.5 0 53.8a53.79 53.79 0 0 1 107.58 0c0 29.7-24.1 54.3-53.79 54.3zM447.9 448h-92.68V302.4c0-34.7-.7-79.2-48.29-79.2-48.29 0-55.69 37.7-55.69 76.7V448h-92.78V148.9h89.08v40.8h1.3c12.4-23.5 42.69-48.3 87.88-48.3 94 0 111.28 61.9 111.28 142.3V448z"></path>
          </svg>
        </a>

        <a class="socialContainer containerFour" href="https://wa.me/yourphonenumber" target="_blank">
