...
<form action="update_product.php" method="post">
    ...
    description: <input type="text" name="description" value="<?php echo $name3; ?>"><br><br>
    education: <input type="text" name="name3" value="<?php echo $name3; ?>"><br><br>
    achievements: <input type="text" name="name3" value="<?php echo $name3; ?>"><br><br>
    ...
    <label>Profile Picture:</label><br>
        ...
        <input type="submit" value='Cancel' onclick="location.href='profile.php?studid=<?php echo $studid; ?>'">
</form>
